...
neopixels_var.NeoPixelNotifier_neopixel_logo_last_var = 9;
...
neopixels_var.NeoPixelNotifier_neopixel_ring_last_var = 7;
neopixels_var.NeoPixelNotifier_NeoPixelStateChart_breath_speed_var = 100;
neopixels_var.NeoPixelNotifier_neopixel_total_count_var = 10;
...
neopixels_var.NeoPixelNotifier_neopixel_logo_first_var = 8;
