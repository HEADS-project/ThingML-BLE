...
//Region OnCradle
uint8_t BLENotifierThermo_BLENotifierSC_OnCradle_State_event_consumed = 0;
if (_instance->BLENotifierThermo_BLENotifierSC_OnCradle_State == BLENOTIFIERTHERMO_BLENOTIFIERSC_ONCRADLE_RED_STATE) {
if (BLENotifierThermo_BLENotifierSC_OnCradle_State_event_consumed == 0 && 1) {
BLENotifierThermo_BLENotifierSC_OnExit(BLENOTIFIERTHERMO_BLENOTIFIERSC_ONCRADLE_RED_STATE, _instance);
_instance->BLENotifierThermo_BLENotifierSC_OnCradle_State = BLENOTIFIERTHERMO_BLENOTIFIERSC_ONCRADLE_STDBY_STATE;
BLENotifierThermo_BLENotifierSC_OnEntry(BLENOTIFIERTHERMO_BLENOTIFIERSC_ONCRADLE_STDBY_STATE, _instance);
...
if (sender == gwcmd_var.id_gateway) {
BLENotifierThermo_handle_gateway_cancel_request(&notifier_var);
