...
#define NEOPIXELNOTIFIERTEST_TEST_GREEN_STATE 1
#define NEOPIXELNOTIFIERTEST_TEST_OFF_STATE 2
#define NEOPIXELNOTIFIERTEST_TEST_BREATH_STATE 3
#define NEOPIXELNOTIFIERTEST_TEST_PULSE_STATE 4
#define NEOPIXELNOTIFIERTEST_TEST_PUMP_STATE 5
#define NEOPIXELNOTIFIERTEST_TEST_MEASURE_STATE 6
...
//Prototypes: Function
void f_NeoPixelNotifierTest_breath(struct NeoPixelNotifierTest_Instance *_instance);
void f_NeoPixelNotifierTest_pulse(struct NeoPixelNotifierTest_Instance *_instance);
void f_NeoPixelNotifierTest_pump(struct NeoPixelNotifierTest_Instance *_instance);
void f_NeoPixelNotifierTest_measure(struct NeoPixelNotifierTest_Instance *_instance);
void f_NeoPixelNotifierTest_solid(struct NeoPixelNotifierTest_Instance *_instance, uint8_t r, uint8_t g, uint8_t b);
...
f_NeoPixelNotifierTest_solid(_instance, 0, 255, 32);
...
neo_var.NeoPixelNotifier_neopixel_total_count_var = 4;
neo_var.NeoPixelNotifier_neopixel_ring_first_var = 0;
neo_var.NeoPixelNotifier_neopixel_ring_last_var = 2;
neo_var.NeoPixelNotifier_neopixel_logo_first_var = 3;
neo_var.NeoPixelNotifier_neopixel_logo_last_var = 3;
...
test_var.NeoPixelNotifierTest_Test_State = NEOPIXELNOTIFIERTEST_TEST_GREEN_STATE;
