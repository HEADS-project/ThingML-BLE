...
/*****************************************************************************
 * Definitions for configuration : BLEGWNotifier
 *****************************************************************************/
...
//Instance neopixels
// Variables for the properties of the instance
struct NeoPixelNotifierGW_Instance neopixels_var;
// Variables for the sessions of the instance
...
NeoPixelNotifierGW_handle_ctrl_setColor(&neopixels_var, param_red, param_green, param_blue);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_blink(&neopixels_var);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_rotate(&neopixels_var, param_speed);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_off(&neopixels_var);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_breath(&neopixels_var);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_setRingColor(&neopixels_var, param_red, param_green, param_blue);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_setLogoColor(&neopixels_var, param_red, param_green, param_blue);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_pulse(&neopixels_var);
...
if (sender == timer2_instance.listener_id) {
NeoPixelNotifierGW_handle_clock_fps_clock(&neopixels_var);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_solid(&neopixels_var);
...
if (sender == notifier_var.id_neopixels) {
NeoPixelNotifierGW_handle_ctrl_blink_logo(&neopixels_var);
...
void initialize_configuration_BLEGWNotifier() {
...
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_State = NEOPIXELNOTIFIERGW_NEOPIXELSTATECHART_PULSE_STATE;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_l_color_g_var = 10;
neopixels_var.NeoPixelNotifierGW_neopixel_logo_first_var = 1;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_BLINKLOGO_counter_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_color_b_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_breath_speed_var = 100;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_color_r_var = 100;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_l_color_r_var = 100;
neopixels_var.NeoPixelNotifierGW_neopixel_ring_last_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_BLINKALL_maxcount_var = 22;
neopixels_var.NeoPixelNotifierGW_ring_brightness_divider_var = 1;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_ROTATE_maxangle_var = 200;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_PULSE_counter_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_BLINKALL_counter_var = 0;
neopixels_var.NeoPixelNotifierGW_neopixel_logo_last_var = 2;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_l_color_b_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_BLINKLOGO_maxcount_var = 22;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_color_g_var = 10;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_ROTATE_angle_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_rotate_speed_var = 4;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_BREATH_maxcount_var = 186;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_PULSE_maxcount_var = 100;
neopixels_var.NeoPixelNotifierGW_neopixel_pin_var = 7;
neopixels_var.NeoPixelNotifierGW_neopixel_total_count_var = 3;
neopixels_var.NeoPixelNotifierGW_neopixel_ring_first_var = 0;
neopixels_var.NeoPixelNotifierGW_NeoPixelStateChart_BREATH_counter_var = 0;

NeoPixelNotifierGW_NeoPixelStateChart_OnEntry(NEOPIXELNOTIFIERGW_NEOPIXELSTATECHART_STATE, &neopixels_var);
...
void setup() {
initialize_configuration_BLEGWNotifier();
