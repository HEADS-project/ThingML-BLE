...
neopixels_var.NeoPixelNotifier_neopixel_logo_first_var = 0;
...
neopixels_var.NeoPixelNotifier_neopixel_total_count_var = 3;
neopixels_var.NeoPixelNotifier_neopixel_pin_var = 7;
neopixels_var.NeoPixelNotifier_neopixel_logo_last_var = 0;
...
neopixels_var.NeoPixelNotifier_neopixel_ring_first_var = 1;
