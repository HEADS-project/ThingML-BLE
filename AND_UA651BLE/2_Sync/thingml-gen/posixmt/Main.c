...
void Main_send_Gateway_MqttBloodPressureMeasurement(struct Main_Instance *_instance, float Systolic, float Diastolic, float MeanArterial, uint8_t UnitKPA, uint16_t Year, uint8_t Month, uint8_t Day, uint8_t Hour, uint8_t Minute, uint8_t Second, float Pulse, uint8_t IrregularPulse);
...
Main_send_Gateway_MqttBloodPressureMeasurement(_instance, Systolic, Diastolic, MeanArterial, UnitKPA, Year, Month, Day, Hour, Minute, Second, Pulse, IrregularPulse);
...
void Main_handle_Gateway_MqttConfirmBloodPressureMeasurement(struct Main_Instance *_instance) {
//Region States
uint8_t Main_States_State_event_consumed = 0;
if (_instance->Main_States_State == MAIN_STATES_STANDBY_STATE) {
//Region Standby
...
void Main_handle_Gateway_MqttRequestBloodPressureMeasurement(struct Main_Instance *_instance) {
//Region States
uint8_t Main_States_State_event_consumed = 0;
if (_instance->Main_States_State == MAIN_STATES_STANDBY_STATE) {
//Region Standby
...
void (*external_Main_send_Gateway_MqttBloodPressureMeasurement_listener)(struct Main_Instance *, float, float, float, uint8_t, uint16_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, float, uint8_t)= 0x0;
void (*Main_send_Gateway_MqttBloodPressureMeasurement_listener)(struct Main_Instance *, float, float, float, uint8_t, uint16_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, float, uint8_t)= 0x0;
...
external_Main_send_Gateway_MqttBloodPressureMeasurement_listener = _listener;
}
...
Main_send_Gateway_MqttBloodPressureMeasurement_listener = _listener;
}
void Main_send_Gateway_MqttBloodPressureMeasurement(struct Main_Instance *_instance, float Systolic, float Diastolic, float MeanArterial, uint8_t UnitKPA, uint16_t Year, uint8_t Month, uint8_t Day, uint8_t Hour, uint8_t Minute, uint8_t Second, float Pulse, uint8_t IrregularPulse){
if (Main_send_Gateway_MqttBloodPressureMeasurement_listener != 0x0) Main_send_Gateway_MqttBloodPressureMeasurement_listener(_instance, Systolic, Diastolic, MeanArterial, UnitKPA, Year, Month, Day, Hour, Minute, Second, Pulse, IrregularPulse);
if (external_Main_send_Gateway_MqttBloodPressureMeasurement_listener != 0x0) external_Main_send_Gateway_MqttBloodPressureMeasurement_listener(_instance, Systolic, Diastolic, MeanArterial, UnitKPA, Year, Month, Day, Hour, Minute, Second, Pulse, IrregularPulse);
;
}
...
switch(portID) {
case 3:{
Main_handle_Gateway_MqttRequestBloodPressureMeasurement(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 3:{
Main_handle_Gateway_MqttConfirmBloodPressureMeasurement(_instance);
return 1;
break;
}
}
