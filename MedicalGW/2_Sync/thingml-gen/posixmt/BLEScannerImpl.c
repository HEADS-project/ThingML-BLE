...
switch(portID) {
case 0:{
BLEScannerImpl_handle_Scanner_Start(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLEScannerImpl_handle_Scanner_Stop(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 1:{
BLEScannerImpl_handle_HCIEvents_SetLEScanParametersCompleted(_instance,
...
switch(portID) {
case 1:{
BLEScannerImpl_handle_HCIEvents_SetLEScanEnableCompleted(_instance,
...
switch(portID) {
case 1:{
BLEScannerImpl_handle_HCIEvents_LEAdvertisementReport(_instance,
...
BLEScannerImpl_States_OnEntry(_instance->initState, _instance);
}
    while(1){
        BLEScannerImpl_processMessageQueue(_instance);
    }
}
