...
void enqueue_BLENotifierImpl_Notifications_NotifierConnect(struct BLENotifierImpl_Instance * inst, uint8_t AddressType, bdaddr_t Address) {
    ...
    if ( fifo_byte_available(&(inst->fifo)) > 11 ) {
        ...
        _fifo_enqueue(&(inst->fifo), (101 >> 8) & 0xFF );
        _fifo_enqueue(&(inst->fifo), 101 & 0xFF );
...
void enqueue_BLENotifierImpl_Notifications_NotifierRequest(struct BLENotifierImpl_Instance * inst) {
    ...
    if ( fifo_byte_available(&(inst->fifo)) > 4 ) {
        ...
        _fifo_enqueue(&(inst->fifo), (102 >> 8) & 0xFF );
        _fifo_enqueue(&(inst->fifo), 102 & 0xFF );
...
void enqueue_BLENotifierImpl_Notifications_NotifierError(struct BLENotifierImpl_Instance * inst) {
    ...
    if ( fifo_byte_available(&(inst->fifo)) > 4 ) {
        ...
        _fifo_enqueue(&(inst->fifo), (103 >> 8) & 0xFF );
        _fifo_enqueue(&(inst->fifo), 103 & 0xFF );
...
void enqueue_BLENotifierImpl_Notifications_NotifierReceived(struct BLENotifierImpl_Instance * inst) {
    ...
    if ( fifo_byte_available(&(inst->fifo)) > 4 ) {
        ...
        _fifo_enqueue(&(inst->fifo), (104 >> 8) & 0xFF );
        _fifo_enqueue(&(inst->fifo), 104 & 0xFF );
...
void enqueue_BLENotifierImpl_Notifications_NotifierStored(struct BLENotifierImpl_Instance * inst) {
    ...
    if ( fifo_byte_available(&(inst->fifo)) > 4 ) {
        ...
        _fifo_enqueue(&(inst->fifo), (105 >> 8) & 0xFF );
        _fifo_enqueue(&(inst->fifo), 105 & 0xFF );
...
switch(portID) {
case 0:{
BLENotifierImpl_handle_Notifications_NotifierConnect(_instance,
...
switch(portID) {
case 0:{
BLENotifierImpl_handle_Notifications_NotifierRequest(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLENotifierImpl_handle_Notifications_NotifierError(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLENotifierImpl_handle_Notifications_NotifierReceived(_instance);
return 1;
break;
}
}
...
switch(portID) {
case 0:{
BLENotifierImpl_handle_Notifications_NotifierStored(_instance);
return 1;
break;
}
}
