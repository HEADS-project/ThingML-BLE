...
#define BLENOTIFIERIMPL_STATES_CONNECTED_SETREADNOTIFICATIONS_STATE 3
#define BLENOTIFIERIMPL_STATES_CONNECTED_WAITFORCOMMAND_STATE 4
#define BLENOTIFIERIMPL_STATES_CONNECTED_SENDCOMMAND_STATE 5
